...
<div style="background-color: #2E2D2F; border-radius: 30px; padding: 30px;">
    ...
    <form action="{{ route('horario.store') }}" method="POST" id="registration-form" onsubmit="return validateForm()">
        @csrf
        <div class="row">
            <div class="col-6">
            ...
            <div class="col-6">
                <div class="input-field">
                    <label style="color: #FFFFFF;">Hora:</label>
                    <input type="time" name="hora" class="custom-input" required>
                </div>
            </div>
        </div>
