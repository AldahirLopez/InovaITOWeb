...
<style>
    ...
    /* Estilos para enlaces deshabilitados con clase "disabled-link" */
    .disabled-link {
        ...
        pointer-events: none;
        /* Deshabilita los eventos de puntero para que no se pueda hacer clic */
    }
</style>
        ...
        <div class="card card-primary left-card" style="background-color: #F2F2F2; height: 520px;">
            ...
            <div class="card-body">
                <div class="text-center">
                    <a href="#" class="btn btn-primary btn-block disabled-link">Etapa Local</a>

                    <a href="{{ route('login.get') }}"  class="btn btn-primary btn-block">Etapa Regional</a>
                    <a href="#" class="btn btn-primary btn-block disabled-link">Etapa Nacional</a>
                </div>
            </div>
        </div>
    </div>
