...
<div style="background-color: #2E2D2F; border-radius: 30px; padding: 30px;">
    ...
    <div class="form-row">
        <div class="form-group input-field" style="flex-basis: calc(50% - 5px);">
    ...
    <div class="form-row">
        <div class="form-group input-field">
            ...
            <span id="numIne-error" class="error-message" style="display: none;">El número de INE no es válido.</span>
        </div>
        <div class="form-group input-field">
        ...
        <div class="form-group input-field">
            ...
            <span id="telefono-error" class="error-message" style="display: none;">El número de teléfono no es válido.</span>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group input-field">
