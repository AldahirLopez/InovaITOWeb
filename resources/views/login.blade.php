...
<div class="row no-gutters">
    <div class="col-md-6">
        <div class="card card-primary left-card" style="background-color: #F2F2F2; height: 450px;">
    ...
    <div class="col-md-6">
        ...
        <div class="card card-primary right-card" style="background-color: #D9D9D9; height: 450px;">
