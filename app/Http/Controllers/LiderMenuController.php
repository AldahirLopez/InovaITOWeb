...
class liderMenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($this->verificarCorreoService->verificarCorreoExistente($correo)) {
            return redirect()->route('lider.liderMenu')->with('error', 'El correo ya está registrado. Intente con otro.');
        }
        ...
        return redirect()->route('liderMenu.index')->with('success', 'Lider registrado correctamente');
